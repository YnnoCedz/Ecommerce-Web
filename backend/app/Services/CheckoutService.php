    ...
    public function checkout(User $buyer, array $data): Order
    {
        ...
        return DB::transaction(function () use ($buyer, $data, $isCartCheckout) {
            ...
            $order = Order::create([
                ...
                'shipping_region_code' => $address->region_code,
                'shipping_region_label' => $address->region,
                'shipping_province_code' => $address->province_code,
                'shipping_city_code' => $address->city_code,
                'shipping_barangay_code' => $address->barangay_code,
                'shipping_barangay_label' => $address->barangay,
                'subtotal' => $subtotal,
            ...
            foreach ($groups as $lines) {
                ...
                $sellerOrder = SellerOrder::create([
                    ...
                    'pickup_store_name' => $seller->trade_name ?: $seller->business_name,
                    'pickup_contact_name' => $seller->contact_name,
                    'pickup_contact_phone' => $seller->contact_phone,
                    'pickup_address_line1' => $seller->address_line1,
                    'pickup_address_line2' => $seller->address_line2,
                    'pickup_region_code' => $seller->region_code,
                    'pickup_region_label' => $seller->region,
                    'pickup_province_code' => $seller->province_code,
                    'pickup_province_label' => $seller->province,
                    'pickup_city_code' => $seller->city_code,
                    'pickup_city_label' => $seller->city,
                    'pickup_barangay_code' => $seller->barangay_code,
                    'pickup_barangay_label' => $seller->barangay,
                    'pickup_postal_code' => $seller->postal_code,
                ]);
