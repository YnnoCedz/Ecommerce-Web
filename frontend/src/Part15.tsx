...
const QA_ITEMS: QAItem[] = [
  ...
  // ── Routing ────────────────────────────────────────────────
  { id: "RT01", category: "Routing", area: "URL structure", check: "All major pages have real, bookmarkable URLs", status: "pass", detail: "Public: /, /c/:slug, /p/:id, /s/:id, /search, /cart. Auth: /auth/login, /auth/register. Account: /account/profile, /account/orders. Seller: /seller-center/*. Admin: /admin/*." },
  ...
  { id: "RT06", category: "Routing", area: "Redirects", check: "Index redirects work: /spec → /spec/01, /account → /account/profile, /auth → /auth/login", status: "pass", detail: "All implemented via { index: true, element: <Navigate to='...' replace /> } patterns in the router." },
