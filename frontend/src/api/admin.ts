...
export type AdminOrder = { id: number; order_number: string; status: string; payment_status: string; grand_total: number; currency: string; buyer_name: string | null; created_at: string | null; payment_method: string | null; placed_at: string | null; shipping: { name: string; phone: string; address: string }; buyer: { id: number; name: string; email: string } | null; seller_orders: Array<{ id: number; status: string; total: number; tracking_number: string | null; seller: { id: number; name: string } | null }>; items: Array<{ id: number; seller_order_id: number | null; product_name: string; sku: string; quantity: number; unit_price: number; subtotal: number }>; payments: Array<{ id: number; type: string; method: string; status: string; amount: number; reference: string | null; created_at: string | null }> };
