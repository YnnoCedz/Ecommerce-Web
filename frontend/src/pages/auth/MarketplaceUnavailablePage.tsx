...
export default function MarketplaceUnavailablePage() {
  ...
  const body = status === "pending" ? "Your Maketo identity is verified. An administrator is reviewing your Marketplace application." : status === "rejected" ? "Your Marketplace application was not approved. Your other approved Maketo capabilities remain available." : "This Maketo identity does not have approved Buyer access."
