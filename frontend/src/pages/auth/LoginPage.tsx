...
export default function LoginPage({ onNavigate }: { onNavigate: NavFn }) {
  ...
  const simulate = () => {
    ...
    setTimeout(() => {
      ...
      if (password !== "correct") setError("Incorrect email or password. Please try again.");
    }, 1200);
  };
  ...
  return (
    <AuthLayout
      ...
      <div>
        ...
        <Field label="" type="password" value={password} onChange={setPassword}
      ...
      {/* Social auth (design state only) */}
      <div className="grid grid-cols-2 gap-3">
        {[
          { label: "Google", icon: <svg width="15" height="15" viewBox="0 0 18 18" fill="none"><path d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844a4.14 4.14 0 01-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.875 2.684-6.615z" fill="#4285F4"/><path d="M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 009 18z" fill="#34A853"/><path d="M3.964 10.71A5.41 5.41 0 013.682 9c0-.593.102-1.17.282-1.71V4.958H.957A8.996 8.996 0 000 9c0 1.452.348 2.827.957 4.042l3.007-2.332z" fill="#FBBC05"/><path d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 00.957 4.958L3.964 7.29C4.672 5.163 6.656 3.58 9 3.58z" fill="#EA4335"/></svg> },
          { label: "Facebook", icon: <svg width="15" height="15" viewBox="0 0 18 18" fill="#1877F2"><path d="M18 9a9 9 0 10-10.406 8.89v-6.288H5.309V9h2.285V7.01c0-2.257 1.344-3.503 3.4-3.503.985 0 2.015.175 2.015.175V5.91h-1.135c-1.118 0-1.467.694-1.467 1.406V9h2.496l-.399 2.602h-2.097v6.287A9.003 9.003 0 0018 9z" /></svg> },
        ].map(({ label, icon }) => (
