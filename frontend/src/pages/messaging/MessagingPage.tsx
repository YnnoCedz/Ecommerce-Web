...
export default function MessagingPage() {
  ...
  return (
    <div className="mx-auto max-w-screen-xl px-4 py-6 md:px-8 lg:px-12">
      <div className="mb-5 flex items-end justify-between"><div><h1 className="font-[var(--font-display)] text-2xl">Messages</h1><p className="mt-1 text-sm text-[var(--color-ink-muted)]">Your private conversations are loaded from Marketo.</p></div><span className="text-xs text-[var(--color-ink-muted)]">{loading ? "Loading..." : `${conversations.length} conversations`}</span></div>
